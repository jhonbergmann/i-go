...
import {Participant} from '@/screens/components/Participant'
...
export function Home() {
  ...
  const todayDate = format(new Date(), "EEEE, dd 'de' MMMM 'de' yyyy'.'", {
    locale: ptBR,
  })
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.eventDate}>{todayDate}</Text>
